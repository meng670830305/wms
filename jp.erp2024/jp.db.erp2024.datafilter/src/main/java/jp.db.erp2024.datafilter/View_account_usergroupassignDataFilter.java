 ...
 * 文件:        View_account_usergroupassignDataFilter.java
 * 项目名称：    工程项目管理
 * 创建时间：    2023/11/13
 * 负责人:      wangyp
...
public final class View_account_usergroupassignDataFilter extends DataFilterBase< View_account_usergroupassign >
{
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public View_account_usergroupassignDataFilter()
	{
	}
	 ...
	 * @throws Exception
	 */
	public PagedResult< View_account_usergroupassign > getPageResult(View_account_usergroupassignMapper mapper) throws Exception
    {
	 ...
	 * @throws Exception
	 */
	public PagedResult< View_account_usergroupassign > getPageResult(View_account_usergroupassignMapper mapper, String andWhere) throws Exception
    {
        ...
        java.util.List< View_account_usergroupassign > list = mapper.selectPage(offset, pageSize, where, sortField);
        int recordCount = mapper.selectCount(where);
        PagedResult< View_account_usergroupassign > result = new PagedResult< View_account_usergroupassign >(list, pageIndex, pageSize, recordCount);
        return result;
    }
}
