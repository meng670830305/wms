 ...
 * 文件:        Account_grouppermissionassign.java
 * 项目名称：    工程项目管理
 * 创建时间：    2023/11/16
 * 负责人:      wangyp
 */
...
/**
 * Account_grouppermissionassign 实体类
 */
@SuppressWarnings("serial")
public class Account_grouppermissionassign implements java.io.Serializable, Cloneable , IEntity 
{

    /**
	 *
	 */
    public static final String _ACCOUNT_GROUPPERMISSIONASSIGN_ = "account_grouppermissionassign";
	/**
	 *自增ID
	 */
	...
	/**
	 *Account_grouppermissionassign 无参构造函数
	 */
	public Account_grouppermissionassign()
	{
	}
	/**
	 *Account_grouppermissionassign 有参构造函数
	 */
	public Account_grouppermissionassign
	(
		Integer id,
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof Account_grouppermissionassign){
			Account_grouppermissionassign other = (Account_grouppermissionassign)obj;
	...
	public String toString() {
		return "Account_grouppermissionassign {"
             + this.id + ','
                     + this.groupid + ','
                     + this.permissionid + ','
                     + this.createtime + ','
    ...
    public static java.lang.reflect.Field[] get_Fields() {
		if (_fields == null || _fields.length == 0) {
			_fields = Account_grouppermissionassign.class.getDeclaredFields();
		}
		return _fields;
	}
