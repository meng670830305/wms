...
/**
 * Mybatis业务逻辑View_account_userroleassignService类型
 */
//springboot 需要指定包扫描的名称
//@SpringBootApplication(scanBasePackages = {"jp.db.erp2024.service"})
@Component("view_account_userroleassignService")
public class View_account_userroleassignService
{
    public View_account_userroleassignService()
    {
    }
