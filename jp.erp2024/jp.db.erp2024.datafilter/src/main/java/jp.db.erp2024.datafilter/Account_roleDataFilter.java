 ...
 * 文件:        Account_roleDataFilter.java
 * 项目名称：    工程项目管理
 * 创建时间：    2023/11/13
 * 负责人:      wangyp
...
public final class Account_roleDataFilter extends DataFilterBase< Account_role >
{
	 ...
	 * @throws Exception
	 */
	public PagedResult< Account_role > getPageResult(Account_roleMapper mapper) throws Exception
    {
	 ...
	 * @throws Exception
	 */
	public PagedResult< Account_role > getPageResult(Account_roleMapper mapper, String andWhere) throws Exception
    {
        ...
        java.util.List< Account_role > list = mapper.selectPage(offset, pageSize, where, sortField);
        int recordCount = mapper.selectCount(where);
        PagedResult< Account_role > result = new PagedResult< Account_role >(list, pageIndex, pageSize, recordCount);
        return result;
    }
}
