...
public class Account_role implements java.io.Serializable, Cloneable , IEntity 
{

    /**
	 *
	 */
    public static final String _ACCOUNT_ROLE_ = "account_role";
	/**
	 *自增ID
	 */
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof Account_role){
			Account_role other = (Account_role)obj;
    ...
    public static java.lang.reflect.Field[] get_Fields() {
		if (_fields == null || _fields.length == 0) {
			_fields = Account_role.class.getDeclaredFields();
		}
		return _fields;
	}
