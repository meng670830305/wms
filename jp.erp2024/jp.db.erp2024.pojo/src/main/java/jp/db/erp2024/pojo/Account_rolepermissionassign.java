 ...
 * 文件:        Account_rolepermissionassign.java
 * 项目名称：    工程项目管理
 * 创建时间：    2023/11/16
 * 负责人:      wangyp
 */
...
/**
 * Account_rolepermissionassign 实体类
 */
@SuppressWarnings("serial")
public class Account_rolepermissionassign implements java.io.Serializable, Cloneable , IEntity 
{

    /**
	 *
	 */
    public static final String _ACCOUNT_ROLEPERMISSIONASSIGN_ = "account_rolepermissionassign";
	/**
	 *自增ID
	 */
	...
	/**
	 *Account_rolepermissionassign 无参构造函数
	 */
	public Account_rolepermissionassign()
	{
	}
	/**
	 *Account_rolepermissionassign 有参构造函数
	 */
	public Account_rolepermissionassign
	(
		Integer id,
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof Account_rolepermissionassign){
			Account_rolepermissionassign other = (Account_rolepermissionassign)obj;
	...
	public String toString() {
		return "Account_rolepermissionassign {"
             + this.id + ','
                     + this.roleid + ','
                     + this.permissionid + ','
                     + this.createtime + ','
    ...
    public static java.lang.reflect.Field[] get_Fields() {
		if (_fields == null || _fields.length == 0) {
			_fields = Account_rolepermissionassign.class.getDeclaredFields();
		}
		return _fields;
	}
