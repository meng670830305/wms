 ...
 * 文件:        Account_grouppermissionassignDataFilter.java
 * 项目名称：    工程项目管理
 * 创建时间：    2023/11/13
 * 负责人:      wangyp
...
public final class Account_grouppermissionassignDataFilter extends DataFilterBase< Account_grouppermissionassign >
{
	 ...
	 * 
	 */
	public Account_grouppermissionassignDataFilter()
	{
	}
	 ...
	 * @throws Exception
	 */
	public PagedResult< Account_grouppermissionassign > getPageResult(Account_grouppermissionassignMapper mapper) throws Exception
    {
	 ...
	 * @throws Exception
	 */
	public PagedResult< Account_grouppermissionassign > getPageResult(Account_grouppermissionassignMapper mapper, String andWhere) throws Exception
    {
        ...
        java.util.List< Account_grouppermissionassign > list = mapper.selectPage(offset, pageSize, where, sortField);
        int recordCount = mapper.selectCount(where);
        PagedResult< Account_grouppermissionassign > result = new PagedResult< Account_grouppermissionassign >(list, pageIndex, pageSize, recordCount);
        return result;
    }
}
