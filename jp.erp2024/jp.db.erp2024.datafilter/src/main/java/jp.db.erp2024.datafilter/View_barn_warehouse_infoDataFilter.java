 ...
 * 文件:        View_barn_warehouse_infoDataFilter.java
 * 项目名称：    工程项目管理
 * 创建时间：    2023/11/17
 * 负责人:      wangyp
...
public final class View_barn_warehouse_infoDataFilter extends DataFilterBase< View_barn_warehouse_info >
{
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public View_barn_warehouse_infoDataFilter()
	{
	}
	 ...
	 * @throws Exception
	 */
	public PagedResult< View_barn_warehouse_info > getPageResult(View_barn_warehouse_infoMapper mapper) throws Exception
    {
	 ...
	 * @throws Exception
	 */
	public PagedResult< View_barn_warehouse_info > getPageResult(View_barn_warehouse_infoMapper mapper, String andWhere) throws Exception
    {
        ...
        java.util.List< View_barn_warehouse_info > list = mapper.selectPage(offset, pageSize, where, sortField);
        int recordCount = mapper.selectCount(where);
        PagedResult< View_barn_warehouse_info > result = new PagedResult< View_barn_warehouse_info >(list, pageIndex, pageSize, recordCount);
        return result;
    }
}
